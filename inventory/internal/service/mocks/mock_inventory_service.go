...
func (_m *InventoryService) GetPart(ctx context.Context, orderUUID string) (model.Part, error) {
...
//   - ctx context.Context
//   - orderUUID string
func (_e *InventoryService_Expecter) GetPart(ctx interface{}, orderUUID interface{}) *InventoryService_GetPart_Call {
	return &InventoryService_GetPart_Call{Call: _e.mock.On("GetPart", ctx, orderUUID)}
}

func (_c *InventoryService_GetPart_Call) Run(run func(ctx context.Context, orderUUID string)) *InventoryService_GetPart_Call {
