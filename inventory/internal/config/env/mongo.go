...
type mongoEnvConfig struct {
	...
	DisabledMockPartsInit bool   `env:"MONGO_DISABLED_INIT_MOCK_PARTS,required"`
}
...
func (cfg *mongoConfig) DisabledInitMockParts() bool {
	return cfg.raw.DisabledMockPartsInit
}
