...
import (
	...
	model "github.com/Alexey-step/rocket-factory/inventory/internal/model"
...
// GetPart provides a mock function with given fields: ctx, orderUUID
func (_m *InventoryRepository) GetPart(ctx context.Context, orderUUID string) (model.Part, error) {
...
//   - ctx context.Context
//   - orderUUID string
func (_e *InventoryRepository_Expecter) GetPart(ctx interface{}, orderUUID interface{}) *InventoryRepository_GetPart_Call {
	return &InventoryRepository_GetPart_Call{Call: _e.mock.On("GetPart", ctx, orderUUID)}
}

func (_c *InventoryRepository_GetPart_Call) Run(run func(ctx context.Context, orderUUID string)) *InventoryRepository_GetPart_Call {
...
type InventoryRepository_InitParts_Call struct {
	*mock.Call
}
...
func (_c *InventoryRepository_InitParts_Call) Return() *InventoryRepository_InitParts_Call {
	_c.Call.Return()
	return _c
}
